...
// router.post('/uploadPictureProfile/viewDocument',(req,res)=>{
...
//           cb(null,req.cookies.iduser+'-'+ file.fieldname + '-' + Date.now()+'.docx')
//         }
//     })
...
router.post('',TeacherController.processProfile);
